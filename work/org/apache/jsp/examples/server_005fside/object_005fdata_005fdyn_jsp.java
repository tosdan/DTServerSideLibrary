...
public final class object_005fdata_005fdyn_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<script type=\"text/javascript\" src=\"./js/fnReloadAjax.js\"></script>\n");
      out.write("\t\t\n");
      ...
      out.write("\t\t<script type=\"text/javascript\" src=\"./js/setActionGenericoPulsanteAzione_dyn.js\"></script> \n");
      out.write("\t\t<script type=\"text/javascript\" src=\"./js/fnConfiguraCustomToobar_dyn.js\"></script> <!-- Configura pulsanti e azioni collegate  --> \n");
      out.write("\t\t\n");
 ...
 // TODO l'idea e' passare questi oggetti nella request 
      ...
      out.write("     \t\t\t];\n");
      out.write("\t\t\t\n");
      out.write("\t\t\tvar sAjaxSource = \"../../dtreply/loadData.do?sqlName=dtexample&sqlType=query\";\n");
      out.write("\t\t\t\n");
      out.write("\t\t</script>\n");
      out.write("\t</head>\n");
      out.write("\t\n");
